...
function notCachedHtmlResponse() {
  var html = '<!doctype html><html lang="es"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1">'
    ...
    + '</style></head><body><div class="card"><div class="eyebrow">Visor Web-ZIP</div><h1 class="title" id="title">Este enlace no se puede abrir aquí</h1><p class="body" id="lead">La dirección que has usado es una URL local del navegador donde se guardó el recurso. No es la URL correcta para compartir.</p><p class="body" id="body">Para abrir este material necesitas la URL de compartir correcta. Pide el enlace generado con el botón Compartir del visor, normalmente uno que incluye <strong>?url=...</strong> o <strong>?key=...</strong>.</p><ul class="list" id="tips"><li>Si este enlace te lo ha enviado otra persona, pídele la URL correcta para compartir.</li><li>Si tú guardaste este material antes en este navegador, vuelve a la página principal del visor y ábrelo otra vez con el enlace correcto.</li></ul><div class="actions"><a class="button button--primary" href="/" id="home-link">Ir al visor</a></div></div><script>(function(){function normalizeLang(l){if(!l)return\"es\";l=String(l).toLowerCase().split(/[-_]/)[0];return[\"es\",\"ca\",\"gl\",\"eu\",\"en\",\"de\"].indexOf(l)!==-1?l:\"es\";}var path=location.pathname||\"/\";function getHomeHref(){var marker=\"/site/\";var idx=path.indexOf(marker);if(idx===-1)return\"/\";var base=path.slice(0,idx+1);return base||\"/\";}var lang=normalizeLang((function(){try{return localStorage.getItem(\"visor-lang\");}catch(e){return null;}})()||navigator.language||\"es\");var copy={es:{title:\"Este enlace no se puede abrir aquí\",lead:\"La dirección que has usado es una URL local del navegador donde se guardó el recurso. No es la URL correcta para compartir.\",body:\"Para abrir este material necesitas la URL de compartir correcta. Pide el enlace generado con el botón Compartir del visor, normalmente uno que incluye ?url=... o ?key=....\",tips:[\"Si este enlace te lo ha enviado otra persona, pídele la URL correcta para compartir.\",\"Si tú guardaste este material antes en este navegador, vuelve a la página principal del visor y ábrelo otra vez con el enlace correcto.\"],home:\"Ir al visor\"},ca:{title:\"Aquest enllaç no es pot obrir aquí\",lead:\"L’adreça que has fet servir és una URL local del navegador on es va desar el recurs. No és la URL correcta per compartir.\",body:\"Per obrir aquest material necessites l’URL correcta per compartir. Demana l’enllaç generat amb el botó Compartir del visor, normalment un que inclou ?url=... o ?key=....\",tips:[\"Si aquest enllaç te l’ha enviat una altra persona, demana-li la URL correcta per compartir.\",\"Si tu havies desat aquest material abans en aquest navegador, torna a la pàgina principal del visor i obre’l de nou amb l’enllaç correcte.\"],home:\"Anar al visor\"},gl:{title:\"Esta ligazón non se pode abrir aquí\",lead:\"O enderezo que usaches é unha URL local do navegador onde se gardou o recurso. Non é a URL correcta para compartir.\",body:\"Para abrir este material necesitas a URL correcta para compartir. Pide a ligazón xerada co botón Compartir do visor, normalmente unha que inclúe ?url=... ou ?key=....\",tips:[\"Se esta ligazón cha enviou outra persoa, pídelle a URL correcta para compartir.\",\"Se ti gardaras este material antes neste navegador, volve á páxina principal do visor e ábreo outra vez coa ligazón correcta.\"],home:\"Ir ao visor\"},eu:{title:\"Esteka hau ezin da hemen ireki\",lead:\"Erabili duzun helbidea baliabidea gorde zen nabigatzaileko URL lokala da. Ez da partekatzeko URL zuzena.\",body:\"Material hau irekitzeko partekatzeko URL zuzena behar duzu. Eskatu ikuslearen Partekatu botoiarekin sortutako esteka, normalean ?url=... edo ?key=... daramana.\",tips:[\"Beste norbaitek bidali badizu esteka hau, eskatu partekatzeko URL zuzena.\",\"Material hau lehenago nabigatzaile honetan gorde bazenuen, itzuli ikuslearen orri nagusira eta ireki berriro esteka zuzenarekin.\"],home:\"Joan ikuslerara\"},en:{title:\"This link cannot be opened here\",lead:\"The address you used is a local browser URL where the resource was stored. It is not the correct sharing URL.\",body:\"To open this material you need the correct sharing URL. Ask for the link generated with the Share button in the viewer, usually one that includes ?url=... or ?key=....\",tips:[\"If someone sent you this link, ask them for the proper sharing URL.\",\"If you previously saved this material in this browser, go back to the main viewer page and open it again with the correct link.\"],home:\"Open viewer\"},de:{title:\"Dieser Link kann hier nicht geöffnet werden\",lead:\"Die verwendete Adresse ist eine lokale Browser-URL, unter der die Ressource gespeichert wurde. Sie ist nicht die richtige Freigabe-URL.\",body:\"Um dieses Material zu öffnen, brauchst du die richtige Freigabe-URL. Bitte um den Link, der mit der Schaltfläche Teilen im Viewer erzeugt wurde, normalerweise mit ?url=... oder ?key=....\",tips:[\"Wenn dir jemand diesen Link geschickt hat, bitte um die richtige Freigabe-URL.\",\"Wenn du dieses Material früher in diesem Browser gespeichert hast, gehe zur Startseite des Viewers zurück und öffne es erneut mit dem richtigen Link.\"],home:\"Zum Viewer\"}};var text=copy[lang]||copy.es;document.documentElement.lang=lang;document.getElementById(\"title\").textContent=text.title;document.getElementById(\"lead\").textContent=text.lead;document.getElementById(\"body\").textContent=text.body;document.getElementById(\"home-link\").textContent=text.home;document.getElementById(\"home-link\").setAttribute(\"href\",getHomeHref());var tips=document.getElementById(\"tips\");tips.innerHTML=\"\";text.tips.forEach(function(item){var li=document.createElement(\"li\");li.textContent=item;tips.appendChild(li);});})();</script></body></html>';
  return new Response(new Blob([html], { type: 'text/html' }), {
    status: 404,
    headers: { 'Content-Type': 'text/html; charset=utf-8', 'Cache-Control': 'no-store' }
  });
