...
function injectOverlayResponse(blob, payload) {
  return blob.text().then(function (html) {
    ...
    var overlay = [
      ...
      'function normalizeLang(l){if(!l)return "es";l=(String(l).toLowerCase()).split(/[-_]/)[0];return ["es","ca","gl","eu","en","de","it","fr","pt"].indexOf(l)!==-1?l:"es";}',
      'var strings={',
      ...
      'pt:{t:"Nova versao disponivel",b:"Este recurso mudou na nuvem. Queres atualiza-lo?",u:"Atualizar",d:"Agora nao",rt:"Acesso restrito",rb:"Este recurso nao esta disponivel neste momento.",wt:"Aviso",wb:"O tempo de acesso termina em {minutes} minutos.",wc:"Fechar"}',
      '};',
