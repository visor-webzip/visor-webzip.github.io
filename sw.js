...
function injectOverlayResponse(blob, payload) {
  return blob.text().then(function (html) {
    ...
    var overlay = [
      ...
      'function normalizeLang(l){if(!l)return "es";l=(String(l).toLowerCase()).split(/[-_]/)[0];return ["es","ca","gl","eu","en","de","it"].indexOf(l)!==-1?l:"es";}',
      'var strings={',
