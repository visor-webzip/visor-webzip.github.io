(function () {
  window.I18N = {
    ...
    it: {
      page: { title: 'Visore Web-ZIP' },
      loading: {
        title: 'Caricamento del materiale',
        message: 'Preparazione in corso...',
        eta: 'Tempo stimato di download: --',
        etaPrefix: 'Tempo stimato di download: ',
        downloadedPrefix: 'Scaricato: ',
        note: 'Le prossime volte la visualizzazione sarà immediata.'
      },
      header: {
        eyebrow: 'Materiali in ZIP',
        title: 'Visore Web-ZIP',
        help: 'Aiuto',
        settings: 'Impostazioni',
        settingsHint: 'Configura la disponibilità della risorsa',
        language: 'Lingua',
        languageHint: 'Cambia lingua',
        theme: 'Tema',
        themeHint: 'Cambia tema',
        themeAuto: 'Automatico',
        themeLight: 'Chiaro',
        themeDark: 'Scuro',
        subtitle: 'Crea, visualizza in anteprima e condividi risorse educative digitali. Condividi il link e la tua risorsa potrà essere aperta direttamente in qualsiasi browser.'
      },
      settings: {
        title: 'Impostazioni di visibilità',
        languageTitle: 'Lingua',
        restrictTitle: 'Accesso per date',
        restrictHint: 'Qui puoi definire quando la risorsa sarà visibile e quali azioni saranno disponibili nella gestione delle risorse.',
        restrictToggle: 'Limitare l’accesso',
        startLabel: 'Inizio',
        endLabel: 'Fine',
        hasStart: 'Attivare la data di inizio della visibilità della risorsa',
        neverExpires: 'Attivare la data di fine della visibilità della risorsa',
        enforceEndDuringView: 'Disattivare la visualizzazione della risorsa al raggiungimento della data di fine mentre è aperta',
        warningMinutesLabel: 'Avviso preventivo in minuti (0 per nessun avviso)',
        warningMessageLabel: 'Messaggio di avviso',
        warningMessagePlaceholder: 'Il tempo di accesso terminerà tra {minutes} minuti.',
        warningMessageDefault: 'Il tempo di accesso terminerà tra {minutes} minuti.',
        periodHint: 'La risorsa sarà visibile solo entro questo intervallo.',
        periodHintLiveEndOn: 'La visualizzazione verrà disattivata al raggiungimento della data di fine.',
        periodHintLiveEndOff: 'La visualizzazione non verrà disattivata automaticamente al raggiungimento della data di fine.',
        periodHintWarningOn: 'Comparirà un avviso {minutes} minuti prima.',
        periodHintWarningOff: 'Non ci sarà alcun avviso preventivo.',
        summaryLiveEndOn: 'Si disattiva alla data di fine',
        summaryLiveEndOff: 'Nessuna disattivazione automatica',
        summaryWarningOn: 'Avviso: {minutes} min prima',
        summaryWarningOff: 'Nessun avviso preventivo',
        summaryNoRestrictions: 'Risorsa senza restrizioni di visibilità.',
        summaryAllowedActions: 'Azioni consentite nella gestione delle risorse: {actions}',
        summaryNoActions: 'nessuna',
        summaryBlockedActions: 'Non saranno consentite: {actions}',
        summaryNoBlockedActions: 'nessuna',
        datesTitle: 'Periodo di visibilità',
        actionsTitle: 'Azioni disponibili mentre la risorsa è visibile',
        allowShare: 'Condividere',
        allowEmbed: 'Incorporare',
        allowDownload: 'Scaricare'
      },
      restrictionModal: {
        title: 'Accesso limitato',
        body: 'Questa risorsa non è disponibile in questo momento.',
        rangeStart: 'Disponibile dal: {date}',
        rangeEnd: 'Fino al: {date}',
        rangeNoStart: 'Senza data di inizio',
        rangeNoEnd: 'Senza data di fine',
        countdown: 'Disponibile tra: {time}'
      },
      lang: {
        label: 'Lingua',
        es: 'Español',
      ...
      footer: {
        ...
        analyticsLink: 'Privacy',
        analyticsNotice: 'Questa applicazione raccoglie solo statistiche di utilizzo aggregate con un sistema proprio per conoscerne l’uso e migliorare lo strumento. Non vengono memorizzati indirizzi IP né utilizzati cookie di analisi per i visitatori.',
        analytics: {
          visits: 'Visite',
          today: 'Oggi',
          details: 'Statistiche'
      ...
      tab: {
        home: 'Inizio',
        downloadZip: 'Opzioni e download',
        manager: 'Gestione risorse',
        help: 'Aiuto'
      },
      publish: {
        title: 'Pubblicare una risorsa',
        subtitle: 'Scegli come vuoi iniziare.',
        back: 'Torna all’inizio',
        choice: {
          zipper: {
            title: 'Creare uno ZIP (web, PDF o DOCX)',
            note: 'Crea uno ZIP da file locali o da HTML. Può includere anche file PDF e DOCX.',
            restrictHint: 'Puoi anche applicare limiti di accesso per date.'
          },
          main: {
            title: 'Creare il link',
            subtitle: 'Ho già il {type} nel cloud',
            subtitleAny: 'Ho già uno ZIP, ELPX o H5P nel cloud con link',
            types: {
              any: 'ZIP, ELPX o H5P',
              zip: 'ZIP',
              elpx: 'ELPX',
            ...
            note: 'Incolla il link pubblico e crea il link del visore.',
            secondaryHtml: 'Se usi un file .elpx di eXeLearning, puoi aprirlo anche qui <span class="info-dot" data-i18n-aria-label="publish.choice.main.elpxTooltip" aria-label="Che cos’è ELPX?">?<span class="info-dot__tooltip" role="tooltip" data-i18n-html="publish.choice.main.elpxTooltipHtml">Un file .elpx è un progetto di eXeLearning che internamente usa il formato ZIP, il che permette al visore di accedere al suo contenuto e mostrarlo correttamente.</span></span>',
            elpxTooltip: 'Che cos’è ELPX?',
            elpxTooltipHtml: 'Un file .elpx è un progetto di eXeLearning che internamente usa il formato ZIP, il che permette al visore di accedere al suo contenuto e mostrarlo correttamente.'
          }
        },
        flow: {
          uploadTitle: 'Caricare la risorsa'
        },
        quick: {
          optionALabel: 'Opzione A',
          optionAText: 'Se la tua risorsa è nel tuo computer (file e cartelle), l’hai copiata da un’IA (codice HTML), oppure se devi applicare date o altre restrizioni, caricala o incollala qui.',
          optionBLabel: 'Opzione B',
          optionBText: 'Se hai già uno ZIP, ELPX o H5P condiviso nel cloud (Drive, Dropbox, Nextcloud, ecc.) con un link pubblico, incolla direttamente qui l’indirizzo.',
          intro: 'Scegli una di queste due opzioni:<br><br><strong>Opzione A:</strong> Se la tua risorsa educativa digitale è in cartelle, file o codice HTML, oppure se devi impostare date di accesso o altre restrizioni, caricala prima nell’area superiore.<br><br><strong>Opzione B:</strong> Se hai già uno ZIP, ELPX o H5P con link pubblico nel tuo servizio di archiviazione nel cloud (Drive, Dropbox, Nextcloud, ecc.) e non devi modificarlo, incolla quell’indirizzo in «Opzione B».',
          newResource: 'Reimposta',
          newResourceTooltip: 'Riavvia l’applicazione per aggiungere nuove risorse o passare all’altra opzione.',
          files: {
            title: 'Caricare file o cartelle',
            dropTitle: 'Trascina qui la cartella o i file',
            loadedTitle: 'Caricamento completato',
            loadedHint: 'Puoi trascinare o scegliere di nuovo altri file, oppure continuare qui sotto per configurare la risorsa.',
            dropHint: 'Si aprirà direttamente l’opzione di creazione dello ZIP.',
            folder: 'Scegli cartella',
            files: 'Scegli file'
          },
          html: {
            title: 'Hai del codice HTML? Incollalo qui',
            placeholder: '<!doctype html>...',
            apply: 'Usa questo HTML'
          },
          fastDownload: 'Download rapido',
          fastDownloadDetail: 'salta le opzioni e scarica la risorsa con le seguenti restrizioni:',
          fastDownloadTooltip: 'Genera il file e lo scarica direttamente, senza passare dalla schermata delle opzioni né dall’anteprima. Le restrizioni di visibilità configurate nelle impostazioni vengono applicate automaticamente al file scaricato.',
          changeRestrictions: 'Cambiare le restrizioni'
        }
      },
      tabs: {
        label: 'Sezioni'
      ...
      main: {
        subtitle: 'Se la tua risorsa è già in formato ZIP, ELPX, H5P o SCORM 1.2 (in ZIP) ed è ospitata in un servizio con <strong>link pubblico</strong> (Drive, Dropbox, ecc.), incolla qui il link per generare il link del visore.',
        form: {
          title: 'Ho già uno ZIP, ELPX o H5P nel cloud con link',
          step: 'Incolla il link pubblico dello ZIP (o .elpx/.h5p) nell’Opzione B e fai clic su «Creare il link».',
          placeholder: 'Incolla qui il link pubblico dello ZIP, .elpx o .h5p (valido anche se include PDF o DOCX)',
          submit: 'Creare il link'
        },
        output: {
          title: 'Link da condividere',
          step: 'Condividi questo link affinché altre persone possano vedere la tua risorsa.',
          placeholder: 'Link da condividere',
          copy: 'Copiare il link',
          qr: 'QR',
          copyTooltip: 'Copiare il link',
          qrTooltip: 'QR (ideale per proiettare o stampare)',
          embedTooltip: 'Incorporare in un sito web (genera un iframe pronto da incollare)',
          openTooltip: 'Aprire l’anteprima',
          embed: 'Incorporare in un sito web',
          open: 'Aprire l’anteprima'
        }
      },
      service: {
        drive: 'Google Drive',
        ...
        dropboxPlaceholder: 'https://www.dropbox.com/...',
        boxPlaceholder: 'https://app.box.com/s/...',
        nextcloudPlaceholder: 'https://il-tuo-server/s/...',
        githubPlaceholder: 'https://github.com/utente/repo/archive/refs/heads/main.zip',
        otherPlaceholder: 'https://server.com/file.zip'
      },
      manager: {
        title: 'Risorse salvate',
        subtitle: 'Gestisci lo spazio usato dai materiali archiviati in questo browser.',
        deleteAll: 'Eliminare tutte le risorse',
        deleteAllConfirm: 'Vuoi davvero eliminare tutte le risorse salvate in questo browser? L’azione non può essere annullata.',
        deleteAllHelp: 'Elimina tutte le risorse salvate in questo browser.',
        savedAt: 'Salvata:',
        checkUpdates: 'Cercare aggiornamenti',
        checkUpdatesHelp: 'Verifica se gli ZIP sono cambiati nel cloud.',
        checkUpdatesModalTitle: 'Cercare aggiornamenti',
        checkingUpdates: 'Ricerca di aggiornamenti...',
        checkUpdatesNote: 'Puoi chiudere questa finestra. Il controllo continuerà in background.',
        checkUpdatesProgress: '{done} di {total}',
        checkUpdatesDoneSummary: 'Aggiornamenti: {changed} di {total}.',
        checkUpdatesNone: 'Nessuna risorsa salvata.',
        checkUpdatesDone: 'Controllo completato.',
        checkUpdatesUnavailable: 'Impossibile controllare senza il backend configurato.',
        stats: {
          used: 'Spazio usato',
          total: 'Spazio totale',
          count: 'Risorse salvate'
        },
        sort: {
          label: 'Ordinare per',
          title: 'Titolo',
          ...
          dirAsc: 'Crescente',
          dirDesc: 'Decrescente',
          dirHelp: 'Cambiare il verso dell’ordinamento.'
        },
        settings: {
          open: 'Impostazioni di pulizia',
          modalTitle: 'Impostazioni di pulizia',
          usage: {
            label: 'Limite di utilizzo prima della pulizia',
            help: 'Se si supera questa percentuale della quota, vengono eliminate le risorse più vecchie.'
          },
          days: {
            label: 'Giorni prima di eliminare le risorse vecchie',
            help: 'Se una risorsa non viene aperta entro questo periodo, verrà eliminata automaticamente.',
            suffix: 'giorni',
            never: 'Non scadono mai'
          },
          reset: 'Ripristinare i valori predefiniti',
          resetHelp: 'Tornare a 70% e 30 giorni e applicare la pulizia.'
        },
        actions: {
          view: 'Vedere',
          share: 'Condividere',
          qr: 'QR',
          embed: 'Incorporare in un sito web',
          edit: 'Modificare il titolo',
          download: 'Scaricare il file',
          update: 'Aggiornare',
          updating: 'Aggiornamento...',
          updated: 'Aggiornata'
        },
        editPrompt: 'Titolo della risorsa',
        empty: 'Nessuna risorsa salvata in questo browser.',
        siteNoUrl: 'Sito senza URL',
        noDate: 'senza data'
      },
      badges: {
      ...
      updates: {
        ...
        body: 'Questa risorsa è cambiata nel cloud. Puoi aggiornarla adesso.',
        action: 'Aggiornare',
        dismiss: 'Non ora'
      },
      zipper: {
        title: 'Creare uno ZIP per il visore',
        summary: {
          title: 'Riepilogo del contenuto caricato'
        },
        options: {
          title: 'Opzioni',
          availabilityLabel: 'Configurare la disponibilità della risorsa',
          availabilityEdit: 'Cambiare le impostazioni',
          availabilityInfo: 'Definire quando la risorsa sarà visibile e quali azioni saranno disponibili nella gestione delle risorse.'
        },
        panel: {
          configTitle: 'Impostazioni della risorsa',
          stateTitle: 'Stato della risorsa',
          actionsTitle: 'Azioni',
          startLabel: 'Inizio',
          endLabel: 'Fine',
          permissionsLabel: 'Permessi',
          startImmediate: 'Immediato',
          noEnd: 'Senza data di fine',
          stateAvailable: 'Risorsa disponibile',
          stateAvailableHelp: 'La risorsa può essere aperta adesso.',
          stateAvailableUntil: 'Disponibile fino al {date}.',
          stateScheduled: 'In attesa di apertura',
          stateScheduledHelp: 'Si aprirà il {date}.',
          stateClosed: 'Risorsa non disponibile',
          stateClosedHelp: 'La disponibilità è terminata il {date}.'
        },
        accordion: {
          filesTitle: 'La tua risorsa è fatta di file o hai già uno ZIP/ELPX/H5P? Caricalo qui'
        },
        subtitle: {
          item1: 'Per pubblicare la tua risorsa, metti tutti i file in una cartella e comprimila in un file <strong>.zip</strong>. Può contenere pagine web e/o uno o più file <strong>PDF</strong>.',
          item2: 'Se la tua risorsa è stata creata con <strong>eXeLearning 3 o successivo</strong>, puoi usare direttamente il file <strong>.elpx</strong>.',
          item3: 'Se usi <strong>eXeLearning 2.x</strong>, esporta il progetto in <strong>ZIP</strong> dal programma e continua con <strong>«Ho già uno ZIP»</strong>.'
        },
        exe: {
          tooltip: 'eXeLearning: nella versione 3+ puoi usare direttamente un file .elpx (è già uno ZIP). Versione 2.x: File > Esporta > Sito web > File ZIP compresso. Versione 3.x: File > Scarica come > Sito web.',
          tooltipHtml: '<strong>eXeLearning:</strong><br>• Versione 3+: puoi usare direttamente il file <code>.elpx</code> (è già uno ZIP).<br>• Versione 2.x: File &gt; Esporta &gt; Sito web &gt; File ZIP compresso.<br>• Versione 3.x: File &gt; Scarica come &gt; Sito web.'
        },
        step1: {
          title: 'Aggiungi i tuoi file',
          note: 'Trascina la cartella o seleziona i file con i pulsanti.'
        },
        dropzone: {
          title: 'Rilascia qui la cartella o i file',
          hint: 'Le cartelle interne vengono mantenute.',
          folder: 'Scegli cartella',
          files: 'Scegli file'
        },
        status: {
          empty: 'Nessun file selezionato.',
          filesReady: 'File trovati: {count}.',
          ready: 'Tutto pronto per creare lo ZIP.',
          readyHint: 'Prepara lo ZIP per ottenere il tuo file.',
          selectFirst: 'Seleziona prima dei file o una cartella.',
          previewSelectFirst: 'Per vedere l’anteprima, seleziona dei file o incolla dell’HTML.',
          previewPreparing: 'Preparazione dell’anteprima locale...',
          previewOpened: 'Anteprima aperta in una nuova scheda.',
          previewFailed: 'Impossibile aprire l’anteprima.',
          engineMissing: 'Impossibile caricare il motore ZIP.',
          creating: 'Creazione dello ZIP...',
          downloaded: 'ZIP scaricato. Carica lo ZIP nel tuo cloud, condividilo in modo che tutti possano vederlo e incolla il link nell’Opzione B.',
          failed: 'Impossibile creare lo ZIP. Controlla i file.',
          created: {
            html: 'ZIP creato: visore web HTML pronto. Carica lo ZIP nel tuo cloud, condividilo in modo che tutti possano vederlo e incolla il link nell’Opzione B.',
            documents: 'ZIP creato: visore di documenti pronto. Carica lo ZIP nel tuo cloud, condividilo in modo che tutti possano vederlo e incolla il link nell’Opzione B.',
            files: 'ZIP creato: visore di file pronto. Carica lo ZIP nel tuo cloud, condividilo in modo che tutti possano vederlo e incolla il link nell’Opzione B.'
          }
        },
        step2: {
          title: 'Scaricare lo ZIP',
          titleDynamic: 'Scaricare il {type}',
          detail: 'Verrà scaricato un file che potrai caricare su Drive, Dropbox, Nextcloud, ecc.',
          forceFolderLabel: 'Forzare il visore di cartelle',
          forceFolderNote: 'Se attivi questa opzione, lo ZIP si aprirà in modalità esplora file: vedrai il contenuto come file organizzati in cartelle, anche quando include HTML o documenti.',
          forceFolderTooltip: 'Maggiori informazioni',
          forceFolderTooltipHtml: 'Se attivi questa opzione, lo ZIP si aprirà in modalità esplora file: vedrai il contenuto come file organizzati in cartelle, anche quando include HTML o documenti.<br><br>Se non la attivi, l’applicazione rileverà automaticamente quale tipo di visore usare.<br><br>Se non sei sicuro, lasciala disattivata.'
        },
        zipName: {
          label: 'Nome dello ZIP',
          placeholder: 'la_mia_risorsa',
          default: 'la_mia_risorsa'
        },
        resourceTitle: {
          label: 'Titolo della risorsa',
          placeholder: 'Lascialo vuoto per usare il titolo della risorsa',
          toggleLabel: 'Assegnare un titolo alla risorsa (titolo attuale: {title})',
          currentEmpty: 'senza titolo'
        },
        build: 'Creare e scaricare lo ZIP',
        buildDynamic: 'Creare e scaricare {type}',
        html: {
          title: 'Non hai file ma hai il codice HTML? Incollalo qui',
          note: 'Incolla l’HTML completo e il visore creerà uno ZIP con un <code>index.html</code> pronto da scaricare.',
          placeholder: '<!doctype html>...',
          build: 'Creare uno ZIP dall’HTML',
          status: {
            ready: 'Tutto pronto per creare lo ZIP dal tuo HTML.',
            reactDetected: 'Questo contenuto sembra React/JSX (non HTML). Copia il prompt e incollalo nella tua chat di IA per convertirlo in HTML.',
            empty: '',
            creating: 'Creazione dello ZIP...',
            downloaded: 'ZIP scaricato. Carica lo ZIP nel tuo cloud, condividilo in modo che tutti possano vederlo e incolla il link nell’Opzione B.',
            failed: 'Impossibile creare lo ZIP. Controlla l’HTML.'
          }
        },
        restrict: {
          title: 'Hai già uno ZIP, ELPX o H5P e vuoi aggiungere restrizioni di visibilità? Caricalo qui',
          note: 'Carica il tuo ZIP, ELPX o H5P e il visore aggiungerà le restrizioni. Poi caricalo su Drive, Dropbox, ecc.',
          lockedText: 'Per usare questa opzione, attiva prima il limite di visibilità della risorsa.',
          lockedAction: 'Attivare il limite',
          lockedStatus: '',
          pick: 'Selezionare lo ZIP',
          apply: 'Applicare le restrizioni e scaricare',
          status: {
            ready: '',
            working: 'Applicazione delle restrizioni...',
            done: '{type} pronto con le restrizioni. Caricalo nel tuo cloud, condividilo in modo che tutti possano vederlo e incolla il link nell’Opzione B.',
            saved: '{type} salvato. Caricalo nel tuo cloud, condividilo in modo che tutti possano vederlo e incolla il link nell’Opzione B.',
            failed: 'Impossibile modificare lo ZIP. Controlla il file.'
          },

          summaryTitle: 'Accesso limitato per date'
        },
        help: {
          inline: 'Se hai già creato un file ZIP, ELPX o H5P e lo hai condiviso in un servizio con link pubblico, vai all’Opzione B.',
          previewTitle: 'Vedere l’anteprima della risorsa prima di scaricarla (facoltativo)',
          nextStepText: 'Il passo successivo è caricare il tuo file nel cloud con un link pubblico. Poi, nell’Opzione B, incolla quel link e crea il link da condividere.',
          previewAction: 'Anteprima',
          previewApplyRestrictions: 'Applicare le restrizioni nell’anteprima',
          previewApplyRestrictionsNote: 'Attivala per verificare come la risorsa si apre e si chiude in base alle date configurate.',
          previewHideResource: 'Anteprima come risorsa non visibile',
          previewOpeningBlocked: 'Questa risorsa non è visibile in questo momento nell’anteprima. Disattiva questa opzione se vuoi vedere come apparirà quando sarà aperta. Lasciala attiva se vuoi vedere come appare quando non è visibile.',
          previewApplyRestrictionsInfo: 'Maggiori informazioni',
          previewApplyRestrictionsInfoHtml: 'Usala per verificare come la risorsa si apre e si chiude in base alle date configurate.',
          goTab: 'Vai all’Opzione B per incollare il link pubblico'
        }
      },
      html: {
        title: 'Scegliere l’HTML iniziale',
        subtitle: 'Non è stato trovato index.html. Seleziona il file HTML che vuoi aprire per primo.',
        confirm: 'Usa questo HTML'
      },
      embed: {
        title: 'Incorporare in un sito web',
        subtitle: 'Copia e incolla questo codice HTML nel tuo sito web per incorporare la tua risorsa.',
        copy: 'Copiare il codice',
        fallback: {
          title: 'Impossibile aprire in modalità incorporata',
          subtitle: 'Il tuo browser o la pagina che la ospita sta bloccando l’archiviazione necessaria. Apri la risorsa in una nuova scheda.',
          open: 'Aprire in una nuova scheda'
        }
      },
      reactPrompt: {
        title: 'Questo sembra React',
        subtitle: 'Questo contenuto sembra React/JSX (non HTML). Copia questo prompt e incollalo nella tua chat di IA affinché lo converta in HTML.',
        prompt: 'Converti questo codice React/JSX in un unico `index.html` che funzioni aprendolo direttamente nel browser (solo HTML, CSS e JavaScript). Restituisci solo il contenuto completo del file HTML.',
        copy: 'Copiare il prompt'
      },
      about: {
        title: 'Aiuto',
        intro: 'Guida rapida per pubblicare, condividere e gestire le risorse nel visore.',
        can: {
          title: 'Che cosa puoi caricare',
          item1: 'ZIP con pagine web statiche e le loro risorse (file HTML, immagini, audio, video, PDF, ecc.).',
          item2: 'Materiali creati con eXeLearning o altri strumenti che esportano in formato web.',
          item3: 'Qualsiasi materiale creato con l’IA (documenti, infografiche, ecc.) che puoi scaricare come pagina web (HTML).',
          item4: 'Cartelle con un file HTML principale (di solito <code>index.html</code>).'
        },
        cant: {
          title: 'Che cosa non funziona o può dare problemi',
          item1: 'Siti web che richiedono un server (moduli che salvano dati, database, PHP, ecc.).',
          item2: 'Link esterni che richiedono l’accesso o permessi speciali.',
          item3: 'ZIP vuoti, danneggiati o incompleti che non si possono aprire correttamente.'
        },
        how: {
          title: 'Come funziona',
          step1: 'Prepara la tua risorsa come una cartella con pagine web (HTML) e comprimila in uno ZIP. Puoi farlo con l’opzione «Creare uno ZIP».',
          step2: 'Carica lo ZIP in un servizio con link pubblico (Google Drive, Dropbox, Nextcloud, GitHub…).',
          step3: 'Condividi il file in modo che chiunque abbia il link possa vederlo.',
          step4: 'Copia l’URL e incollalo nel campo «Incolla qui il link pubblico».',
          step5: 'Il link da condividere è permanente, quindi puoi distribuirlo ai tuoi studenti.'
        },
        drive: {
          title: 'Importante su Google Drive',
          note: 'Google Drive limita i download diretti dei file di grandi dimensioni (circa 25 MB). Se il tuo ZIP supera questa dimensione, potrebbe non funzionare. Dropbox, Nextcloud e altri servizi di solito consentono file più grandi senza questo limite.'
        },
        body: '<nav class="about-index" data-help-nav aria-label="Indice dell’aiuto"><p class="about-index__title">Indice</p><ul><li><a href="#help-goal">Obiettivo</a></li><li><a href="#help-route">Percorso rapido per condividere</a></li><li><a href="#help-share-link">Quale link devo condividere?</a></li><li><a href="#help-tabs">Schede di lavoro</a></li><li><a href="#help-viewer">Quale visore viene creato automaticamente</a></li><li><a href="#help-options">Opzioni prima del download</a></li><li><a href="#help-availability">Disponibilità e azioni</a></li><li><a href="#help-manager">Gestione risorse</a></li><li><a href="#help-faq">FAQ: privacy e dati</a></li></ul></nav><section aria-labelledby="help-goal"><h3 class="about-section-title" id="help-goal" tabindex="-1">Obiettivo</h3><p>Condividere risorse con i tuoi studenti in modo semplice: prepara il materiale, genera il link e distribuiscilo.</p></section><section aria-labelledby="help-route"><h3 class="about-section-title" id="help-route" tabindex="-1">Percorso rapido per condividere</h3><ol class="about-steps"><li>Nell’<strong>Opzione A</strong>, carica la tua risorsa (cartelle, file o ZIP/ELPX/H5P) oppure incolla il codice HTML.</li><li>Rivedi il riepilogo e, se necessario, modifica le <strong>Opzioni</strong> (titolo, disponibilità e forzare il visore di cartelle).</li><li>Nelle <strong>Opzioni</strong>, crea il file finale. Poi caricalo nel tuo cloud con un link pubblico e, nell’<strong>Opzione B</strong>, incolla quell’indirizzo.</li></ol><p>Se hai già lo ZIP, l’ELPX o l’H5P nel cloud con un link pubblico, vai all’<strong>Opzione B</strong> e incolla l’indirizzo.</p></section><section aria-labelledby="help-share-link"><h3 class="about-section-title" id="help-share-link" tabindex="-1">Quale link devo condividere?</h3><p>Condividi sempre il link finale generato da questa applicazione. È il link del visore che compare quando completi l’<strong>Opzione B</strong>, oppure quello che puoi copiare in seguito dalla <strong>Gestione risorse</strong>.</p><p>Non condividere l’indirizzo che vedi nella barra del browser mentre il materiale è aperto. Quell’indirizzo può essere un URL locale memorizzato solo in questo browser e in questo dispositivo, quindi potrebbe non funzionare per un’altra persona anche se funziona per te.</p><p>Se hai già aperto quel materiale in questo browser e devi ritrovarlo, cercalo nella <strong>Gestione risorse</strong>. Ma quando lo invii agli studenti o ad altre persone, usa sempre il link di condivisione del visore.</p></section><section aria-labelledby="help-tabs"><h3 class="about-section-title" id="help-tabs" tabindex="-1">Schede di lavoro</h3><ul><li><strong>Inizio</strong>: contiene entrambe le parti del percorso: <strong>Opzione A</strong> e <strong>Opzione B</strong>.</li><li><strong>Gestione risorse</strong>: apri, copia, incorpora, aggiorna ed elimina le risorse salvate in questo browser.</li></ul></section><section aria-labelledby="help-viewer"><h3 class="about-section-title" id="help-viewer" tabindex="-1">Quale visore viene creato automaticamente</h3><p>L’applicazione rileva il contenuto e sceglie il visore più adatto:</p><ul><li><strong>Visore web</strong>: per risorse con pagine HTML e pacchetti SCORM 1.2.</li><li><strong>Visore H5P</strong>: per contenuti <code>.h5p</code>, sia autonomi sia all’interno di ZIP/ELPX/H5P.</li><li><strong>Visore di documenti</strong>: per file PDF, DOCX, TXT, MD e CSV (inclusa la resa delle formule in Markdown).</li><li><strong>Visore di cartelle</strong>: per esplorare cartelle e file di qualsiasi tipo.</li></ul><p>Puoi vedere l’applicazione in funzione con questi esempi:</p><ul><li><a href="https://visor-webzip.github.io/?key=NO9-KQ_Vkmi6&view=full&entry=__vwz_folder_index.html" target="_blank" rel="noopener">Visore di cartelle</a></li><li><a href="https://visor-webzip.github.io/?key=crBAg-o4BARB&view=full&entry=tetris%2Findex.html" target="_blank" rel="noopener">Visore web</a></li><li><a href="https://visor-webzip.github.io/?key=z3loPNMOj1pW&view=full&entry=__vwz_docs_index.html" target="_blank" rel="noopener">Visore di documenti</a></li><li><a href="https://visor-webzip.github.io/?key=sFUKNJkh0Joq&view=full&entry=__vwz_h5p_index.html" target="_blank" rel="noopener">Visore H5P</a></li></ul><p>Ti consigliamo anche di aprire la <strong>Gestione risorse</strong> per verificare quali azioni sono disponibili per ogni esempio (condividere, incorporare, scaricare o aggiornare).</p></section><section aria-labelledby="help-options"><h3 class="about-section-title" id="help-options" tabindex="-1">Opzioni prima del download</h3><ul><li><strong>Assegnare un titolo alla risorsa</strong>: facoltativo, per personalizzare come appare.</li><li><strong>Configurare la disponibilità della risorsa</strong>: facoltativo, per decidere quando può essere aperta e quali azioni sono consentite.</li><li><strong>Forzare il visore di cartelle</strong>: utile se vuoi che venga sempre mostrata come esplora file.</li><li><strong>Anteprima</strong>: apre una vista locale temporanea per controllare il risultato prima di caricarla.</li></ul></section><section aria-labelledby="help-availability"><h3 class="about-section-title" id="help-availability" tabindex="-1">Disponibilità e azioni</h3><p>Nelle <strong>Opzioni</strong> puoi attivare la disponibilità per date e impostare l’inizio, una fine facoltativa e le azioni nella gestione (condividere, incorporare, scaricare) mentre la risorsa è accessibile.</p><p>Se carichi uno ZIP, ELPX o H5P già esistente, puoi anche aggiungere o modificare queste restrizioni e vedere l’anteprima del risultato prima di generare il link finale.</p></section><section aria-labelledby="help-manager"><h3 class="about-section-title" id="help-manager" tabindex="-1">Gestione risorse</h3><p>La gestione conserva le risorse in questo browser. Da lì puoi aprirle, condividerle, incorporarle, aggiornarle quando il file nel cloud cambia ed eliminarle quando non servono più.</p></section><section aria-labelledby="help-faq"><h3 class="about-section-title" id="help-faq" tabindex="-1">FAQ: privacy e dati</h3><ul><li><strong>Dove vengono archiviate le risorse?</strong> Nell’archiviazione locale del browser di ogni dispositivo.</li><li><strong>Le mie risorse vengono caricate su GitHub o su questa applicazione?</strong> No. Sei tu a ospitare lo ZIP/ELPX/H5P nel tuo archivio cloud. Il visore si limita a scaricarlo e aprirlo nel browser.</li><li><strong>Vengono inviati dati a terzi?</strong> No. Solo il download dello ZIP/ELPX/H5P dal link pubblico che hai indicato.</li><li><strong>Che cosa succede se cancello i dati del browser o cambio dispositivo?</strong> Le risorse locali spariscono in quel browser/dispositivo.</li><li><strong>Chi può vedere la risorsa?</strong> Chiunque abbia il link del visore e accesso al link pubblico del file.</li><li><strong>Come si aggiorna una risorsa?</strong> Sostituisci il file nel cloud senza eliminare il precedente; ogni utente che apra il link condiviso riceverà una notifica per aggiornare la risorsa.</li></ul></section>'
      },
      error: {
        driveTooLarge: 'Il file è troppo grande e Google Drive limita i download. Prova con Nextcloud, Dropbox o un altro servizio.',
        loadZip: 'Impossibile caricare lo ZIP.',
        corruptZip: 'Il file ZIP/ELPX/H5P è danneggiato o incompleto.',
        restricted: 'Questa risorsa non è più disponibile a causa delle restrizioni di date.',
        embedNotAllowed: 'Non è consentito incorporare questa risorsa.',
        popupBlocked: 'Il browser ha bloccato la finestra di anteprima. Consenti i pop-up per questo sito e riprova.',
        noHtmlSelected: 'Nessun HTML selezionato.',
        htmlPickerOpen: 'Impossibile aprire il selettore di HTML.',
        serviceWorkerUnavailable: 'Service worker non disponibile.',
        sha1Unavailable: 'SHA-1 non disponibile in questo browser.',
        configMissing: 'Configura GAS_WEBAPP_URL in config.js.',
        needHtmlFile: 'Lo ZIP deve contenere almeno un file .html.',
        offlineNotAllowed: 'Questo browser non consente il visore offline.',
        fflateMissing: 'Impossibile caricare il motore ZIP (fflate).',
        zipNoWebFiles: 'Lo ZIP non contiene file web.',
        noSpace: 'Spazio insufficiente nel browser.'
      },
      status: {
        preparing: 'Preparazione in corso...',
        preparingZip: 'Preparazione dello ZIP...',
        connecting: 'Connessione',
        downloadingZip: 'Download dello ZIP...',
        restrictedReady: 'Questa risorsa ha restrizioni di date. Il link è pronto.',
        unpacking: 'Estrazione in corso...',
        saving: 'Salvataggio nel browser...',
      ...
      documentViewer: {
        ...
        failedPdf: 'Impossibile mostrare questo PDF.',
        downloadPdf: 'Scaricare il PDF',
        prevPage: 'Precedente',
        nextPage: 'Successiva',
        zoomIn: 'Ingrandire',
        zoomOut: 'Ridurre',
        fitWidth: 'Adattare alla larghezza',
        pageLabel: 'Pagina {current} / {total}',
        missingPdfEngine: 'Impossibile caricare il visore di PDF.',
        loadingDocx: 'Caricamento del DOCX...',
        failedDocx: 'Impossibile mostrare questo DOCX.',
        downloadDocx: 'Scaricare il DOCX',
        missingDocxEngine: 'Impossibile caricare il visore di DOCX.'
      },
      folderViewer: {
        title: 'Modalità cartelle',
        subtitle: 'Esplora cartelle e sottocartelle con icone per tipo di file.',
        searchPlaceholder: 'Cercare file...',
        searchResults: 'Risultati della ricerca',
        selectAll: 'Selezionare i visibili',
        clearSelection: 'Annullare la selezione',
        openSelected: 'Aprire i selezionati',
        downloadAll: 'Scaricare tutto',
        downloadSelected: 'Scaricare la selezione',
        downloadVisible: 'Scaricare l’elenco visibile',
        noResults: 'Nessun file da mostrare.',
        selectedCount: '{count} selezionati',
        openFile: 'Aprire',
        downloadFile: 'Scaricare',
        contextOpen: 'Aprire',
        contextDownload: 'Scaricare',
        contextDownloadVisible: 'Scaricare l’elenco visibile',
        folder: 'Cartella',
        filesWord: 'file'
      },
      common: {
    ...
    fr: {
      page: { title: 'Visionneuse Web-ZIP' },
      loading: {
        title: 'Chargement du matériel',
        message: 'Préparation...',
        eta: 'Temps de téléchargement estimé : --',
        etaPrefix: 'Temps de téléchargement estimé : ',
        downloadedPrefix: 'Téléchargé : ',
        note: 'Les prochaines fois, l’affichage sera instantané.'
      },
      header: {
        eyebrow: 'Matériels en ZIP',
        title: 'Visionneuse Web-ZIP',
        help: 'Aide',
        settings: 'Paramètres',
        settingsHint: 'Configurer la disponibilité de la ressource',
        language: 'Langue',
        languageHint: 'Changer de langue',
        theme: 'Thème',
        themeHint: 'Changer de thème',
        themeAuto: 'Automatique',
        themeLight: 'Clair',
        themeDark: 'Sombre',
        subtitle: 'Créez, prévisualisez et partagez des ressources éducatives numériques. Partagez le lien et votre ressource pourra être ouverte directement dans n’importe quel navigateur.'
      },
      settings: {
        title: 'Paramètres de visibilité',
        languageTitle: 'Langue',
        restrictTitle: 'Accès par dates',
        restrictHint: 'Ici, vous pouvez définir quand la ressource sera visible et quelles actions seront disponibles dans le gestionnaire de ressources.',
        restrictToggle: 'Limiter l’accès',
        startLabel: 'Début',
        endLabel: 'Fin',
        hasStart: 'Activer la date de début de visibilité de la ressource',
        neverExpires: 'Activer la date de fin de visibilité de la ressource',
        enforceEndDuringView: 'Désactiver l’affichage de la ressource lorsque la date de fin est atteinte alors qu’elle est ouverte',
        warningMinutesLabel: 'Avertissement préalable en minutes (0 pour aucun avertissement)',
        warningMessageLabel: 'Message d’avertissement',
        warningMessagePlaceholder: 'Le temps d’accès se termine dans {minutes} minutes.',
        warningMessageDefault: 'Le temps d’accès se termine dans {minutes} minutes.',
        periodHint: 'La ressource ne sera visible que pendant cet intervalle.',
        periodHintLiveEndOn: 'L’affichage sera désactivé lorsque la date de fin sera atteinte.',
        periodHintLiveEndOff: 'L’affichage ne sera pas désactivé automatiquement lorsque la date de fin sera atteinte.',
        periodHintWarningOn: 'Un avertissement apparaîtra {minutes} minutes avant.',
        periodHintWarningOff: 'Il n’y aura aucun avertissement préalable.',
        summaryLiveEndOn: 'Se désactive à la date de fin',
        summaryLiveEndOff: 'Pas de désactivation automatique',
        summaryWarningOn: 'Avertissement : {minutes} min avant',
        summaryWarningOff: 'Aucun avertissement préalable',
        summaryNoRestrictions: 'Ressource sans restrictions de visibilité.',
        summaryAllowedActions: 'Actions autorisées dans le gestionnaire de ressources : {actions}',
        summaryNoActions: 'aucune',
        summaryBlockedActions: 'Ne seront pas autorisées : {actions}',
        summaryNoBlockedActions: 'aucune',
        datesTitle: 'Période de visibilité',
        actionsTitle: 'Actions disponibles pendant que la ressource est visible',
        allowShare: 'Partager',
        allowEmbed: 'Intégrer',
        allowDownload: 'Télécharger'
      },
      restrictionModal: {
        title: 'Accès restreint',
        body: 'Cette ressource n’est pas disponible pour le moment.',
        rangeStart: 'Disponible à partir du : {date}',
        rangeEnd: 'Jusqu’au : {date}',
        rangeNoStart: 'Sans date de début',
        rangeNoEnd: 'Sans date de fin',
        countdown: 'Disponible dans : {time}'
      },
      lang: {
        label: 'Langue',
        es: 'Español',
      ...
      footer: {
        ...
        analyticsLink: 'Confidentialité',
        analyticsNotice: 'Cette application recueille uniquement des statistiques d’utilisation agrégées à l’aide d’un système maison, afin de connaître son usage et d’améliorer l’outil. Aucune adresse IP n’est stockée et aucun cookie d’analyse n’est utilisé pour les visiteurs.',
        analytics: {
          visits: 'Visites',
          today: 'Aujourd’hui',
      ...
      tab: {
        home: 'Accueil',
        downloadZip: 'Options et téléchargements',
        manager: 'Gestionnaire de ressources',
        help: 'Aide'
      },
      publish: {
        title: 'Publier une ressource',
        subtitle: 'Choisissez comment vous voulez commencer.',
        back: 'Revenir au début',
        choice: {
          zipper: {
            title: 'Créer un ZIP (web, PDF ou DOCX)',
            note: 'Créez un ZIP à partir de fichiers locaux ou de code HTML. Il peut aussi contenir des fichiers PDF et DOCX.',
            restrictHint: 'Vous pouvez aussi appliquer des limites d’accès par dates.'
          },
          main: {
            title: 'Créer le lien',
            subtitle: 'J’ai déjà le {type} dans le cloud',
            subtitleAny: 'J’ai déjà un ZIP, ELPX ou H5P dans le cloud avec un lien',
            types: {
              any: 'ZIP, ELPX ou H5P',
              zip: 'ZIP',
              elpx: 'ELPX',
            ...
            note: 'Collez le lien public et créez le lien de la visionneuse.',
            secondaryHtml: 'Si vous utilisez un fichier .elpx d’eXeLearning, vous pouvez aussi l’ouvrir ici <span class="info-dot" data-i18n-aria-label="publish.choice.main.elpxTooltip" aria-label="Qu’est-ce qu’ELPX ?">?<span class="info-dot__tooltip" role="tooltip" data-i18n-html="publish.choice.main.elpxTooltipHtml">Un fichier .elpx est un projet eXeLearning qui utilise en interne le format ZIP, ce qui permet à la visionneuse d’accéder à son contenu et de l’afficher correctement.</span></span>',
            elpxTooltip: 'Qu’est-ce qu’ELPX ?',
            elpxTooltipHtml: 'Un fichier .elpx est un projet eXeLearning qui utilise en interne le format ZIP, ce qui permet à la visionneuse d’accéder à son contenu et de l’afficher correctement.'
          }
        },
        flow: {
          uploadTitle: 'Charger la ressource'
        },
        quick: {
          optionALabel: 'Option A',
          optionAText: 'Si votre ressource se trouve sur votre ordinateur (fichiers et dossiers), si vous l’avez copiée depuis une IA (code HTML), ou si vous devez appliquer des dates ou d’autres restrictions, téléversez-la ou collez-la ici.',
          optionBLabel: 'Option B',
          optionBText: 'Si vous avez déjà un ZIP, ELPX ou H5P partagé dans le cloud (Drive, Dropbox, Nextcloud, etc.) avec un lien public, collez directement l’adresse ici.',
          intro: 'Choisissez l’une de ces deux options :<br><br><strong>Option A :</strong> Si votre ressource éducative numérique se trouve dans des dossiers, des fichiers ou du code HTML, ou si vous devez définir des dates d’accès ou d’autres restrictions, chargez-la d’abord dans la zone supérieure.<br><br><strong>Option B :</strong> Si vous avez déjà un ZIP, ELPX ou H5P avec un lien public dans votre service de stockage cloud (Drive, Dropbox, Nextcloud, etc.) et que vous n’avez pas besoin de le modifier, collez cette adresse dans « Option B ».',
          newResource: 'Réinitialiser',
          newResourceTooltip: 'Réinitialise l’application pour ajouter de nouvelles ressources ou passer à l’autre option.',
          files: {
            title: 'Charger des fichiers ou des dossiers',
            dropTitle: 'Faites glisser le dossier ou les fichiers ici',
            loadedTitle: 'Chargement terminé',
            loadedHint: 'Vous pouvez de nouveau faire glisser ou choisir d’autres fichiers, ou continuer ci-dessous pour configurer la ressource.',
            dropHint: 'L’option de création du ZIP s’ouvrira directement.',
            folder: 'Choisir un dossier',
            files: 'Choisir des fichiers'
          },
          html: {
            title: 'Vous avez du code HTML ? Collez-le ici',
            placeholder: '<!doctype html>...',
            apply: 'Utiliser ce HTML'
          },
          fastDownload: 'Téléchargement rapide',
          fastDownloadDetail: 'ignorer les options et télécharger la ressource avec les restrictions suivantes :',
          fastDownloadTooltip: 'Génère le fichier et le télécharge directement, sans passer par l’écran des options ni par l’aperçu. Les restrictions de visibilité configurées dans les paramètres sont appliquées automatiquement au fichier téléchargé.',
          changeRestrictions: 'Modifier les restrictions'
        }
      },
      tabs: {
        label: 'Sections'
      ...
      main: {
        subtitle: 'Si votre ressource est déjà au format ZIP, ELPX, H5P ou SCORM 1.2 (en ZIP) et hébergée sur un service avec un <strong>lien public</strong> (Drive, Dropbox, etc.), collez le lien ici pour générer le lien de la visionneuse.',
        form: {
          title: 'J’ai déjà un ZIP, ELPX ou H5P dans le cloud avec un lien',
          step: 'Collez le lien public du ZIP (ou .elpx/.h5p) dans l’Option B et cliquez sur « Créer le lien ».',
          placeholder: 'Collez ici le lien public du ZIP, .elpx ou .h5p (valable aussi s’il contient des PDF ou DOCX)',
          submit: 'Créer le lien'
        },
        output: {
          title: 'Lien à partager',
          step: 'Partagez ce lien pour que d’autres personnes puissent voir votre ressource.',
          placeholder: 'Lien à partager',
          copy: 'Copier le lien',
          qr: 'QR',
          copyTooltip: 'Copier le lien',
          qrTooltip: 'QR (idéal pour projeter ou imprimer)',
          embedTooltip: 'Intégrer dans un site web (génère une iframe prête à coller)',
          openTooltip: 'Ouvrir l’aperçu',
          embed: 'Intégrer dans un site web',
      ...
      service: {
        ...
        dropboxPlaceholder: 'https://www.dropbox.com/...',
        boxPlaceholder: 'https://app.box.com/s/...',
        nextcloudPlaceholder: 'https://votre-serveur/s/...',
        githubPlaceholder: 'https://github.com/utilisateur/depot/archive/refs/heads/main.zip',
        otherPlaceholder: 'https://serveur.com/fichier.zip'
      },
      manager: {
        title: 'Ressources enregistrées',
        subtitle: 'Gérez l’espace utilisé par les matériels stockés dans ce navigateur.',
        deleteAll: 'Supprimer toutes les ressources',
        deleteAllConfirm: 'Voulez-vous vraiment supprimer toutes les ressources enregistrées dans ce navigateur ? Cette action est irréversible.',
        deleteAllHelp: 'Supprime toutes les ressources enregistrées dans ce navigateur.',
        savedAt: 'Enregistrée :',
        checkUpdates: 'Rechercher des mises à jour',
        checkUpdatesHelp: 'Vérifie si les ZIP ont changé dans le cloud.',
        checkUpdatesModalTitle: 'Rechercher des mises à jour',
        checkingUpdates: 'Recherche de mises à jour...',
        checkUpdatesNote: 'Vous pouvez fermer cette fenêtre. La vérification continuera en arrière-plan.',
        checkUpdatesProgress: '{done} sur {total}',
        checkUpdatesDoneSummary: 'Mises à jour : {changed} sur {total}.',
        checkUpdatesNone: 'Aucune ressource enregistrée.',
        checkUpdatesDone: 'Vérification terminée.',
        checkUpdatesUnavailable: 'Impossible de vérifier sans le backend configuré.',
        stats: {
          used: 'Espace utilisé',
          total: 'Espace total',
          count: 'Ressources enregistrées'
        },
        sort: {
          label: 'Trier par',
          title: 'Titre',
          ...
          dirAsc: 'Croissant',
          dirDesc: 'Décroissant',
          dirHelp: 'Changer le sens du tri.'
        },
        settings: {
          open: 'Paramètres de nettoyage',
          modalTitle: 'Paramètres de nettoyage',
          usage: {
            label: 'Limite d’utilisation avant nettoyage',
            help: 'Si ce pourcentage du quota est dépassé, les ressources les plus anciennes sont supprimées.'
          },
          days: {
            label: 'Jours avant de supprimer les ressources anciennes',
            help: 'Si une ressource n’est pas ouverte pendant cette période, elle sera supprimée automatiquement.',
            suffix: 'jours',
            never: 'N’expirent jamais'
          },
          reset: 'Rétablir les valeurs par défaut',
          resetHelp: 'Revenir à 70 % et 30 jours et appliquer le nettoyage.'
        },
        actions: {
          view: 'Voir',
          share: 'Partager',
        ...
        editPrompt: 'Titre de la ressource',
        empty: 'Aucune ressource enregistrée dans ce navigateur.',
        siteNoUrl: 'Site sans URL',
        noDate: 'sans date'
      },
      badges: {
      ...
      updates: {
        ...
        body: 'Cette ressource a changé dans le cloud. Vous pouvez la mettre à jour maintenant.',
        action: 'Mettre à jour',
        dismiss: 'Pas maintenant'
      },
      zipper: {
        title: 'Créer un ZIP pour la visionneuse',
        summary: {
          title: 'Résumé du contenu chargé'
        },
        options: {
          title: 'Options',
          availabilityLabel: 'Configurer la disponibilité de la ressource',
          availabilityEdit: 'Modifier les paramètres',
          availabilityInfo: 'Définir quand la ressource sera visible et quelles actions seront disponibles dans le gestionnaire de ressources.'
        },
        panel: {
          configTitle: 'Paramètres de la ressource',
          stateTitle: 'État de la ressource',
          actionsTitle: 'Actions',
          startLabel: 'Début',
          endLabel: 'Fin',
          permissionsLabel: 'Permissions',
          ...
          stateAvailable: 'Ressource disponible',
          stateAvailableHelp: 'La ressource peut être ouverte dès maintenant.',
          stateAvailableUntil: 'Disponible jusqu’au {date}.',
          stateScheduled: 'En attente d’ouverture',
          stateScheduledHelp: 'Elle s’ouvrira le {date}.',
          stateClosed: 'Ressource non disponible',
          stateClosedHelp: 'La disponibilité a pris fin le {date}.'
        },
        accordion: {
          filesTitle: 'Votre ressource est composée de fichiers ou vous avez déjà un ZIP/ELPX/H5P ? Chargez-le ici'
        },
        subtitle: {
          item1: 'Pour publier votre ressource, placez tous les fichiers dans un dossier et compressez-le en un fichier <strong>.zip</strong>. Il peut contenir des pages web et/ou un ou plusieurs fichiers <strong>PDF</strong>.',
          item2: 'Si votre ressource a été créée avec <strong>eXeLearning 3 ou une version ultérieure</strong>, vous pouvez utiliser directement le fichier <strong>.elpx</strong>.',
          item3: 'Si vous utilisez <strong>eXeLearning 2.x</strong>, exportez le projet en <strong>ZIP</strong> depuis le programme et continuez avec <strong>« J’ai déjà un ZIP »</strong>.'
        },
        exe: {
          tooltip: 'eXeLearning : dans la version 3+, vous pouvez utiliser directement un fichier .elpx (c’est déjà un ZIP). Version 2.x : Fichier > Exporter > Site web > Fichier ZIP compressé. Version 3.x : Fichier > Télécharger comme > Site web.',
          tooltipHtml: '<strong>eXeLearning :</strong><br>• Version 3+ : vous pouvez utiliser directement le fichier <code>.elpx</code> (c’est déjà un ZIP).<br>• Version 2.x : Fichier &gt; Exporter &gt; Site web &gt; Fichier ZIP compressé.<br>• Version 3.x : Fichier &gt; Télécharger comme &gt; Site web.'
        },
        step1: {
          title: 'Ajoutez vos fichiers',
          note: 'Faites glisser le dossier ou sélectionnez les fichiers avec les boutons.'
        },
        dropzone: {
          title: 'Déposez le dossier ou les fichiers ici',
          hint: 'Les dossiers internes sont conservés.',
          folder: 'Choisir un dossier',
          files: 'Choisir des fichiers'
        },
        status: {
          ...
          ready: 'Prêt à créer le ZIP.',
          readyHint: 'Préparez le ZIP pour obtenir votre fichier.',
          selectFirst: 'Sélectionnez d’abord des fichiers ou un dossier.',
          previewSelectFirst: 'Pour prévisualiser, sélectionnez des fichiers ou collez du HTML.',
          previewPreparing: 'Préparation de l’aperçu local...',
          previewOpened: 'Aperçu ouvert dans un nouvel onglet.',
          previewFailed: 'Impossible d’ouvrir l’aperçu.',
          engineMissing: 'Le moteur ZIP n’a pas pu être chargé.',
          creating: 'Création du ZIP...',
          downloaded: 'ZIP téléchargé. Téléversez le ZIP dans votre cloud, partagez-le pour que tout le monde puisse le voir et collez le lien dans l’Option B.',
          failed: 'Impossible de créer le ZIP. Vérifiez les fichiers.',
          created: {
            html: 'ZIP créé : visionneuse web HTML prête. Téléversez le ZIP dans votre cloud, partagez-le pour que tout le monde puisse le voir et collez le lien dans l’Option B.',
            documents: 'ZIP créé : visionneuse de documents prête. Téléversez le ZIP dans votre cloud, partagez-le pour que tout le monde puisse le voir et collez le lien dans l’Option B.',
            files: 'ZIP créé : visionneuse de fichiers prête. Téléversez le ZIP dans votre cloud, partagez-le pour que tout le monde puisse le voir et collez le lien dans l’Option B.'
          }
        },
        step2: {
          title: 'Télécharger le ZIP',
          titleDynamic: 'Télécharger le {type}',
          detail: 'Un fichier sera téléchargé, que vous pourrez téléverser sur Drive, Dropbox, Nextcloud, etc.',
          forceFolderLabel: 'Forcer la visionneuse de dossiers',
          forceFolderNote: 'Si vous activez cette option, le ZIP s’ouvrira en mode explorateur de fichiers : vous verrez le contenu sous forme de fichiers organisés en dossiers, même s’il contient du HTML ou des documents.',
          forceFolderTooltip: 'Plus d’informations',
          forceFolderTooltipHtml: 'Si vous activez cette option, le ZIP s’ouvrira en mode explorateur de fichiers : vous verrez le contenu sous forme de fichiers organisés en dossiers, même s’il contient du HTML ou des documents.<br><br>Si vous ne l’activez pas, l’application détectera automatiquement le type de visionneuse à utiliser.<br><br>En cas de doute, laissez-la désactivée.'
        },
        zipName: {
          label: 'Nom du ZIP',
          placeholder: 'ma_ressource',
          default: 'ma_ressource'
        },
        resourceTitle: {
          label: 'Titre de la ressource',
          placeholder: 'Laissez vide pour utiliser le titre de la ressource',
          toggleLabel: 'Donner un titre à la ressource (titre actuel : {title})',
          currentEmpty: 'sans titre'
        },
        build: 'Créer et télécharger le ZIP',
        buildDynamic: 'Créer et télécharger {type}',
        html: {
          title: 'Pas de fichiers mais vous avez le code HTML ? Collez-le ici',
          note: 'Collez le HTML complet et la visionneuse créera un ZIP avec un <code>index.html</code> prêt à être téléchargé.',
          placeholder: '<!doctype html>...',
          build: 'Créer un ZIP à partir du HTML',
          status: {
            ready: 'Prêt à créer le ZIP à partir de votre HTML.',
            reactDetected: 'Ce contenu ressemble à du React/JSX (pas du HTML). Copiez l’invite et collez-la dans votre chat d’IA pour la convertir en HTML.',
            empty: '',
            creating: 'Création du ZIP...',
            downloaded: 'ZIP téléchargé. Téléversez le ZIP dans votre cloud, partagez-le pour que tout le monde puisse le voir et collez le lien dans l’Option B.',
            failed: 'Impossible de créer le ZIP. Vérifiez le HTML.'
          }
        },
        restrict: {
          title: 'Vous avez déjà un ZIP, ELPX ou H5P et vous voulez ajouter des restrictions de visibilité ? Chargez-le ici',
          note: 'Chargez votre ZIP, ELPX ou H5P et la visionneuse ajoutera les restrictions. Téléversez-le ensuite sur Drive, Dropbox, etc.',
          lockedText: 'Pour utiliser cette option, activez d’abord la limite de visibilité de la ressource.',
          lockedAction: 'Activer la limite',
          lockedStatus: '',
          pick: 'Sélectionner le ZIP',
          apply: 'Appliquer les restrictions et télécharger',
          status: {
            ready: '',
            working: 'Application des restrictions...',
            done: '{type} prêt avec les restrictions. Téléversez-le dans votre cloud, partagez-le pour que tout le monde puisse le voir et collez le lien dans l’Option B.',
            saved: '{type} enregistré. Téléversez-le dans votre cloud, partagez-le pour que tout le monde puisse le voir et collez le lien dans l’Option B.',
            failed: 'Impossible de modifier le ZIP. Vérifiez le fichier.'
          },

          summaryTitle: 'Accès limité par dates'
        },
        help: {
          inline: 'Si vous avez déjà créé un fichier ZIP, ELPX ou H5P et que vous l’avez partagé sur un service avec un lien public, allez à l’Option B.',
          previewTitle: 'Prévisualiser la ressource avant de la télécharger (facultatif)',
          nextStepText: 'L’étape suivante consiste à téléverser votre fichier dans le cloud avec un lien public. Ensuite, dans l’Option B, collez ce lien et créez le lien à partager.',
          previewAction: 'Prévisualiser',
          previewApplyRestrictions: 'Appliquer les restrictions dans l’aperçu',
          previewApplyRestrictionsNote: 'Activez-la pour vérifier comment la ressource s’ouvre et se ferme selon les dates configurées.',
          previewHideResource: 'Aperçu en tant que ressource masquée',
          previewOpeningBlocked: 'Cette ressource n’est pas visible pour le moment dans l’aperçu. Désactivez cette option si vous voulez voir à quoi elle ressemblera lorsqu’elle sera ouverte. Laissez-la activée si vous voulez voir à quoi elle ressemble lorsqu’elle n’est pas visible.',
          previewApplyRestrictionsInfo: 'Plus d’informations',
          previewApplyRestrictionsInfoHtml: 'Utilisez-la pour vérifier comment la ressource s’ouvre et se ferme selon les dates configurées.',
          goTab: 'Allez à l’Option B pour coller le lien public'
        }
      },
      html: {
        title: 'Choisir le HTML initial',
        subtitle: 'index.html n’a pas été trouvé. Sélectionnez le fichier HTML que vous voulez ouvrir en premier.',
        confirm: 'Utiliser ce HTML'
      },
      embed: {
        title: 'Intégrer dans un site web',
        subtitle: 'Copiez et collez ce code HTML dans votre site web pour y intégrer votre ressource.',
        copy: 'Copier le code',
        fallback: {
          title: 'Impossible d’ouvrir en mode intégré',
          subtitle: 'Votre navigateur ou la page hôte bloque le stockage nécessaire. Ouvrez la ressource dans un nouvel onglet.',
          open: 'Ouvrir dans un nouvel onglet'
        }
      },
      reactPrompt: {
        title: 'Cela ressemble à du React',
        subtitle: 'Ce contenu ressemble à du React/JSX (pas du HTML). Copiez cette invite et collez-la dans votre chat d’IA pour qu’il la convertisse en HTML.',
        prompt: 'Convertis ce code React/JSX en un seul `index.html` qui fonctionne en l’ouvrant directement dans le navigateur (uniquement HTML, CSS et JavaScript). Renvoie uniquement le contenu complet du fichier HTML.',
        copy: 'Copier l’invite'
      },
      about: {
        title: 'Aide',
        intro: 'Guide rapide pour publier, partager et gérer des ressources dans la visionneuse.',
        can: {
          title: 'Ce que vous pouvez téléverser',
          item1: 'Des ZIP contenant des pages web statiques et leurs ressources (fichiers HTML, images, audio, vidéo, PDF, etc.).',
          item2: 'Des matériels créés avec eXeLearning ou d’autres outils qui exportent vers le web.',
          item3: 'Tout matériel créé avec une IA (documents, infographies, etc.) que vous pouvez télécharger sous forme de page web (HTML).',
          item4: 'Des dossiers avec un fichier HTML principal (généralement <code>index.html</code>).'
        },
        cant: {
          title: 'Ce qui ne fonctionne pas ou peut échouer',
          item1: 'Les sites web qui nécessitent un serveur (formulaires qui enregistrent des données, bases de données, PHP, etc.).',
          item2: 'Les liens externes qui nécessitent une connexion ou des permissions spéciales.',
          item3: 'Les ZIP vides, endommagés ou incomplets qui ne peuvent pas être ouverts correctement.'
        },
        how: {
          title: 'Comment ça marche',
          step1: 'Préparez votre ressource sous forme de dossier contenant des pages web (HTML) et compressez-la en un ZIP. Vous pouvez le faire avec l’option « Créer un ZIP ».',
          step2: 'Téléversez le ZIP sur un service avec un lien public (Google Drive, Dropbox, Nextcloud, GitHub…).',
          step3: 'Partagez le fichier pour que toute personne disposant du lien puisse le voir.',
          step4: 'Copiez l’URL et collez-la dans le champ « Collez ici le lien public ».',
          step5: 'Le lien à partager est permanent, vous pouvez donc le distribuer à vos élèves.'
        },
        drive: {
          title: 'Important à propos de Google Drive',
          note: 'Google Drive limite les téléchargements directs des fichiers volumineux (environ 25 Mo). Si votre ZIP dépasse cette taille, cela peut échouer. Dropbox, Nextcloud et d’autres services autorisent généralement des fichiers plus volumineux sans cette limite.'
        },
        body: '<nav class="about-index" data-help-nav aria-label="Index de l’aide"><p class="about-index__title">Index</p><ul><li><a href="#help-goal">Objectif</a></li><li><a href="#help-route">Parcours rapide pour partager</a></li><li><a href="#help-share-link">Quel lien dois-je partager ?</a></li><li><a href="#help-tabs">Onglets de travail</a></li><li><a href="#help-viewer">Quelle visionneuse est créée automatiquement</a></li><li><a href="#help-options">Options avant le téléchargement</a></li><li><a href="#help-availability">Disponibilité et actions</a></li><li><a href="#help-manager">Gestionnaire de ressources</a></li><li><a href="#help-faq">FAQ : confidentialité et données</a></li></ul></nav><section aria-labelledby="help-goal"><h3 class="about-section-title" id="help-goal" tabindex="-1">Objectif</h3><p>Partager des ressources avec vos élèves de manière simple : préparez le matériel, générez le lien et distribuez-le.</p></section><section aria-labelledby="help-route"><h3 class="about-section-title" id="help-route" tabindex="-1">Parcours rapide pour partager</h3><ol class="about-steps"><li>Dans l’<strong>Option A</strong>, chargez votre ressource (dossiers, fichiers ou ZIP/ELPX/H5P) ou collez le code HTML.</li><li>Vérifiez le résumé et, si nécessaire, ajustez les <strong>Options</strong> (titre, disponibilité et forcer la visionneuse de dossiers).</li><li>Dans les <strong>Options</strong>, créez le fichier final. Téléversez-le ensuite dans votre cloud avec un lien public et, dans l’<strong>Option B</strong>, collez cette adresse.</li></ol><p>Si vous avez déjà le ZIP, l’ELPX ou l’H5P dans le cloud avec un lien public, allez à l’<strong>Option B</strong> et collez l’adresse.</p></section><section aria-labelledby="help-share-link"><h3 class="about-section-title" id="help-share-link" tabindex="-1">Quel lien dois-je partager ?</h3><p>Partagez toujours le lien final généré par cette application. C’est le lien de la visionneuse qui s’affiche lorsque vous terminez l’<strong>Option B</strong>, ou celui que vous pouvez copier plus tard depuis le <strong>Gestionnaire de ressources</strong>.</p><p>Ne partagez pas l’adresse que vous voyez dans la barre du navigateur pendant que le matériel est ouvert. Cette adresse peut être une URL locale enregistrée uniquement dans ce navigateur et sur cet appareil : elle peut donc ne pas fonctionner pour une autre personne, même si elle fonctionne pour vous.</p><p>Si vous avez déjà ouvert ce matériel dans ce navigateur et que vous devez le retrouver, cherchez-le dans le <strong>Gestionnaire de ressources</strong>. Mais lorsque vous l’envoyez à des élèves ou à d’autres personnes, utilisez toujours le lien de partage de la visionneuse.</p></section><section aria-labelledby="help-tabs"><h3 class="about-section-title" id="help-tabs" tabindex="-1">Onglets de travail</h3><ul><li><strong>Accueil</strong> : contient les deux parties du parcours : <strong>Option A</strong> et <strong>Option B</strong>.</li><li><strong>Gestionnaire de ressources</strong> : ouvrez, copiez, intégrez, mettez à jour et supprimez les ressources enregistrées dans ce navigateur.</li></ul></section><section aria-labelledby="help-viewer"><h3 class="about-section-title" id="help-viewer" tabindex="-1">Quelle visionneuse est créée automatiquement</h3><p>L’application détecte le contenu et choisit la visionneuse la plus adaptée :</p><ul><li><strong>Visionneuse web</strong> : pour les ressources avec des pages HTML et les paquets SCORM 1.2.</li><li><strong>Visionneuse H5P</strong> : pour les contenus <code>.h5p</code>, autonomes ou à l’intérieur de ZIP/ELPX/H5P.</li><li><strong>Visionneuse de documents</strong> : pour les fichiers PDF, DOCX, TXT, MD et CSV (y compris le rendu des formules en Markdown).</li><li><strong>Visionneuse de dossiers</strong> : pour parcourir des dossiers et des fichiers de tout type.</li></ul><p>Vous pouvez voir l’application en fonctionnement avec ces exemples :</p><ul><li><a href="https://visor-webzip.github.io/?key=NO9-KQ_Vkmi6&view=full&entry=__vwz_folder_index.html" target="_blank" rel="noopener">Visionneuse de dossiers</a></li><li><a href="https://visor-webzip.github.io/?key=crBAg-o4BARB&view=full&entry=tetris%2Findex.html" target="_blank" rel="noopener">Visionneuse web</a></li><li><a href="https://visor-webzip.github.io/?key=z3loPNMOj1pW&view=full&entry=__vwz_docs_index.html" target="_blank" rel="noopener">Visionneuse de documents</a></li><li><a href="https://visor-webzip.github.io/?key=sFUKNJkh0Joq&view=full&entry=__vwz_h5p_index.html" target="_blank" rel="noopener">Visionneuse H5P</a></li></ul><p>Nous vous recommandons également d’ouvrir le <strong>Gestionnaire de ressources</strong> pour vérifier quelles actions sont disponibles pour chaque exemple (partager, intégrer, télécharger ou mettre à jour).</p></section><section aria-labelledby="help-options"><h3 class="about-section-title" id="help-options" tabindex="-1">Options avant le téléchargement</h3><ul><li><strong>Donner un titre à la ressource</strong> : facultatif, pour personnaliser son affichage.</li><li><strong>Configurer la disponibilité de la ressource</strong> : facultatif, pour décider quand elle peut être ouverte et quelles actions sont autorisées.</li><li><strong>Forcer la visionneuse de dossiers</strong> : utile si vous voulez qu’elle s’affiche toujours comme un explorateur de fichiers.</li><li><strong>Aperçu</strong> : ouvre une vue locale temporaire pour vérifier le résultat avant de téléverser.</li></ul></section><section aria-labelledby="help-availability"><h3 class="about-section-title" id="help-availability" tabindex="-1">Disponibilité et actions</h3><p>Dans les <strong>Options</strong>, vous pouvez activer la disponibilité par dates et définir le début, une fin facultative et les actions du gestionnaire (partager, intégrer, télécharger) pendant que la ressource est accessible.</p><p>Si vous chargez un ZIP, ELPX ou H5P existant, vous pouvez aussi ajouter ou modifier ces restrictions et prévisualiser le résultat avant de générer le lien final.</p></section><section aria-labelledby="help-manager"><h3 class="about-section-title" id="help-manager" tabindex="-1">Gestionnaire de ressources</h3><p>Le gestionnaire conserve les ressources dans ce navigateur. Vous pouvez y les ouvrir, les partager, les intégrer, les mettre à jour lorsque le fichier change dans le cloud et les supprimer lorsqu’elles ne servent plus.</p></section><section aria-labelledby="help-faq"><h3 class="about-section-title" id="help-faq" tabindex="-1">FAQ : confidentialité et données</h3><ul><li><strong>Où les ressources sont-elles stockées ?</strong> Dans le stockage local du navigateur de chaque appareil.</li><li><strong>Mes ressources sont-elles téléversées sur GitHub ou sur cette application ?</strong> Non. C’est vous qui hébergez le ZIP/ELPX/H5P dans votre stockage cloud. La visionneuse se contente de le télécharger et de l’ouvrir dans le navigateur.</li><li><strong>Des données sont-elles envoyées à des tiers ?</strong> Non. Uniquement le téléchargement du ZIP/ELPX/H5P depuis le lien public que vous avez indiqué.</li><li><strong>Que se passe-t-il si j’efface les données du navigateur ou si je change d’appareil ?</strong> Les ressources locales disparaissent dans ce navigateur/appareil.</li><li><strong>Qui peut voir la ressource ?</strong> Toute personne disposant du lien de la visionneuse et ayant accès au lien public du fichier.</li><li><strong>Comment met-on à jour une ressource ?</strong> Remplacez le fichier dans le cloud sans supprimer le précédent ; toute personne qui ouvre le lien partagé recevra une notification pour mettre à jour la ressource.</li></ul></section>'
      },
      error: {
        driveTooLarge: 'Le fichier est trop volumineux et Google Drive limite les téléchargements. Essayez Nextcloud, Dropbox ou un autre service.',
        loadZip: 'Impossible de charger le ZIP.',
        corruptZip: 'Le fichier ZIP/ELPX/H5P est endommagé ou incomplet.',
        restricted: 'Cette ressource n’est plus disponible en raison des restrictions de dates.',
        embedNotAllowed: 'L’intégration n’est pas autorisée pour cette ressource.',
        popupBlocked: 'Le navigateur a bloqué la fenêtre d’aperçu. Autorisez les fenêtres contextuelles pour ce site et réessayez.',
        noHtmlSelected: 'Aucun HTML sélectionné.',
        htmlPickerOpen: 'Impossible d’ouvrir le sélecteur de HTML.',
        serviceWorkerUnavailable: 'Service worker non disponible.',
        sha1Unavailable: 'SHA-1 non disponible dans ce navigateur.',
        configMissing: 'Configurez GAS_WEBAPP_URL dans config.js.',
        needHtmlFile: 'Le ZIP doit contenir au moins un fichier .html.',
        offlineNotAllowed: 'Ce navigateur n’autorise pas la visionneuse hors ligne.',
        fflateMissing: 'Impossible de charger le moteur ZIP (fflate).',
        zipNoWebFiles: 'Le ZIP ne contient pas de fichiers web.',
        noSpace: 'Espace insuffisant dans le navigateur.'
      },
      status: {
        preparing: 'Préparation...',
        preparingZip: 'Préparation du ZIP...',
        connecting: 'Connexion',
        downloadingZip: 'Téléchargement du ZIP...',
        restrictedReady: 'Cette ressource est soumise à des restrictions de dates. Le lien est prêt.',
        unpacking: 'Décompression...',
        saving: 'Enregistrement dans le navigateur...',
      ...
      documentViewer: {
        ...
        failedPdf: 'Impossible d’afficher ce PDF.',
        ...
        pageLabel: 'Page {current} / {total}',
        missingPdfEngine: 'Impossible de charger la visionneuse de PDF.',
        loadingDocx: 'Chargement du DOCX...',
        failedDocx: 'Impossible d’afficher ce DOCX.',
        downloadDocx: 'Télécharger le DOCX',
        missingDocxEngine: 'Impossible de charger la visionneuse de DOCX.'
      },
      folderViewer: {
        title: 'Mode dossiers',
        subtitle: 'Parcourez dossiers et sous-dossiers avec des icônes par type de fichier.',
        searchPlaceholder: 'Rechercher des fichiers...',
        searchResults: 'Résultats de la recherche',
        selectAll: 'Sélectionner les visibles',
        clearSelection: 'Annuler la sélection',
        openSelected: 'Ouvrir la sélection',
        downloadAll: 'Tout télécharger',
        downloadSelected: 'Télécharger la sélection',
        downloadVisible: 'Télécharger la liste visible',
        noResults: 'Aucun fichier à afficher.',
        selectedCount: '{count} sélectionnés',
        openFile: 'Ouvrir',
        downloadFile: 'Télécharger',
        contextOpen: 'Ouvrir',
        contextDownload: 'Télécharger',
        contextDownloadVisible: 'Télécharger la liste visible',
        folder: 'Dossier',
        filesWord: 'fichiers'
      },
      common: {
  ...
  function applyBoxMentions_() {
    var replacementsByLang = {
      ...
      it: [
        ['(Drive, Dropbox, Nextcloud, ecc.)', '(Drive, Dropbox, Box.com, Nextcloud, ecc.)'],
        ['(Drive, Dropbox, ecc.)', '(Drive, Dropbox, Box.com, ecc.)'],
        ['Drive, Dropbox, Nextcloud, GitHub…', 'Drive, Dropbox, Box.com, Nextcloud, GitHub…'],
        ['Dropbox, Nextcloud e altri servizi', 'Dropbox, Box.com, Nextcloud e altri servizi'],
        ['Nextcloud, Dropbox o un altro servizio', 'Nextcloud, Dropbox, Box.com o un altro servizio']
      ],
      fr: [
        ['(Drive, Dropbox, Nextcloud, etc.)', '(Drive, Dropbox, Box.com, Nextcloud, etc.)'],
        ['(Drive, Dropbox, etc.)', '(Drive, Dropbox, Box.com, etc.)'],
