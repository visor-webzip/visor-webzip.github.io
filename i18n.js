    ...
    es: {
      ...
      main: {
        ...
        form: {
          ...
          step: 'Pega el enlace público al ZIP (o .elpx/.h5p) en ② Crear enlace y pulsa “Crear enlace”.',
      ...
      zipper: {
        ...
        status: {
          ...
          downloaded: 'ZIP descargado. Sube el ZIP a tu nube, compártelo para que todos lo puedan ver y pega el enlace en ② Crear enlace.',
          failed: 'No se pudo crear el ZIP. Revisa los archivos.',
          created: {
            html: 'ZIP creado: visor web HTML listo. Sube el ZIP a tu nube, compártelo para que todos lo puedan ver y pega el enlace en ② Crear enlace.',
            documents: 'ZIP creado: visor de documentos listo. Sube el ZIP a tu nube, compártelo para que todos lo puedan ver y pega el enlace en ② Crear enlace.',
            files: 'ZIP creado: visor de archivos listo. Sube el ZIP a tu nube, compártelo para que todos lo puedan ver y pega el enlace en ② Crear enlace.'
          }
        },
        step2: {
        ...
        restrict: {
          ...
          status: {
            ...
            done: '{type} listo con restricciones. Súbelo a tu nube, compártelo para que todos lo puedan ver y pega el enlace en ② Crear enlace.',
            saved: '{type} guardado. Súbelo a tu nube, compártelo para que todos lo puedan ver y pega el enlace en ② Crear enlace.',
            failed: 'No se pudo modificar el ZIP. Revisa el archivo.'
          }
        },
        help: {
          inline: 'Si ya has creado un archivo ZIP, ELPX o H5P y lo has compartido en un servicio con enlace público, pasa a ② Crear enlace.',
          previewTitle: 'Previsualiza el recurso antes de descargarlo (opcional)',
          nextStepText: 'El siguiente paso es subir tu archivo a la nube con enlace público. Después, en ② Crear enlace, pega ese enlace y crea el enlace para compartir.',
    ...
    ca: {
      ...
      main: {
        ...
        form: {
          ...
          step: 'Enganxa l’enllaç públic al ZIP (o .elpx/.h5p) a ② Crear enllaç i prem “Crear enllaç”.',
      ...
      zipper: {
        ...
        status: {
          ...
          creating: 'Creant ZIP...',
          downloaded: 'ZIP descarregat. Puja el ZIP al teu núvol, comparteix-lo perquè tothom el pugui veure i enganxa l’enllaç a ② Crear enllaç.',
          failed: 'No s’ha pogut crear el ZIP. Revisa els fitxers.',
          created: {
            html: 'ZIP creat: visor web HTML llest. Puja el ZIP al teu núvol, comparteix-lo perquè tothom el pugui veure i enganxa l’enllaç a ② Crear enllaç.',
            documents: 'ZIP creat: visor de documents llest. Puja el ZIP al teu núvol, comparteix-lo perquè tothom el pugui veure i enganxa l’enllaç a ② Crear enllaç.',
            files: 'ZIP creat: visor de fitxers llest. Puja el ZIP al teu núvol, comparteix-lo perquè tothom el pugui veure i enganxa l’enllaç a ② Crear enllaç.'
          }
        },
        step2: {
        ...
        restrict: {
          ...
          status: {
            ...
            done: '{type} llest amb restriccions. Puja’l al teu núvol, comparteix-lo perquè tothom el pugui veure i enganxa l’enllaç a ② Crear enllaç.',
            saved: '{type} desat. Puja’l al teu núvol, comparteix-lo perquè tothom el pugui veure i enganxa l’enllaç a ② Crear enllaç.',
            failed: 'No s’ha pogut modificar el ZIP. Revisa el fitxer.'
          },
          summaryTitle: 'Accés limitat per dates'
        },
        help: {
          inline: 'Si ja has creat un fitxer ZIP, ELPX o H5P i l’has compartit en un servei amb enllaç públic, ves a ② Crear enllaç.',
          previewTitle: 'Previsualitza el recurs abans de descarregar-lo (opcional)',
          nextStepText: 'El següent pas és pujar el fitxer al núvol amb enllaç públic. Després, a ② Crear enllaç, enganxa aquest enllaç i crea l’enllaç per compartir.',
    ...
    gl: {
      ...
      main: {
        ...
        form: {
          ...
          step: 'Pega a ligazón pública ao ZIP (ou .elpx/.h5p) en ② Crear ligazón e preme “Crear ligazón”.',
      ...
      zipper: {
        ...
        status: {
          ...
          creating: 'Creando ZIP...',
          downloaded: 'ZIP descargado. Sube o ZIP á túa nube, compárteo para que todo o mundo o poida ver e pega a ligazón en ② Crear ligazón.',
          failed: 'Non se puido crear o ZIP. Revisa os ficheiros.',
          created: {
            html: 'ZIP creado: visor web HTML listo. Sube o ZIP á túa nube, compárteo para que todo o mundo o poida ver e pega a ligazón en ② Crear ligazón.',
            documents: 'ZIP creado: visor de documentos listo. Sube o ZIP á túa nube, compárteo para que todo o mundo o poida ver e pega a ligazón en ② Crear ligazón.',
            files: 'ZIP creado: visor de ficheiros listo. Sube o ZIP á túa nube, compárteo para que todo o mundo o poida ver e pega a ligazón en ② Crear ligazón.'
          }
        },
        step2: {
        ...
        restrict: {
          ...
          status: {
            ...
            done: '{type} listo con restricións. Súbeo á túa nube, compárteo para que todo o mundo o poida ver e pega a ligazón en ② Crear ligazón.',
            saved: '{type} gardado. Súbeo á túa nube, compárteo para que todo o mundo o poida ver e pega a ligazón en ② Crear ligazón.',
            failed: 'Non se puido modificar o ZIP. Revisa o ficheiro.'
          },
          summaryTitle: 'Acceso limitado por datas'
        },
        help: {
          inline: 'Se xa creaches un arquivo ZIP, ELPX ou H5P e o compartiches nun servizo con ligazón pública, vai a ② Crear ligazón.',
          previewTitle: 'Previsualiza o recurso antes de descargalo (opcional)',
          nextStepText: 'O seguinte paso é subir o arquivo á nube cunha ligazón pública. Despois, en ② Crear ligazón, pega esa ligazón e crea a ligazón para compartir.',
          previewAction: 'Previsualizar',
    ...
    eu: {
      ...
      main: {
        ...
        form: {
          ...
          step: 'Itsatsi ZIParen esteka publikoa (edo .elpx/.h5p) ② Esteka sortu atalean eta sakatu “Esteka sortu”.',
      ...
      zipper: {
        ...
        status: {
          ...
          downloaded: 'ZIPa deskargatuta. Igo ZIPa zure hodeira, partekatu denek ikus dezaten eta itsatsi esteka ② Esteka sortu atalean.',
          failed: 'Ezin izan da ZIPa sortu. Berrikusi fitxategiak.',
          created: {
            html: 'ZIPa sortuta: web bistaratzailea prest. Igo ZIPa zure hodeira, partekatu denek ikus dezaten eta itsatsi esteka ② Esteka sortu atalean.',
            documents: 'ZIPa sortuta: dokumentuen bistaratzailea prest. Igo ZIPa zure hodeira, partekatu denek ikus dezaten eta itsatsi esteka ② Esteka sortu atalean.',
            files: 'ZIPa sortuta: fitxategi-bistaratzailea prest. Igo ZIPa zure hodeira, partekatu denek ikus dezaten eta itsatsi esteka ② Esteka sortu atalean.'
          }
        },
        step2: {
        ...
        restrict: {
          ...
          status: {
            ...
            done: '{type} prest murrizketekin. Igo ezazu zure hodeira, partekatu denek ikus dezaten eta itsatsi esteka ② Esteka sortu atalean.',
            saved: '{type} gordeta. Igo ezazu zure hodeira, partekatu denek ikus dezaten eta itsatsi esteka ② Esteka sortu atalean.',
            failed: 'Ezin izan da ZIPa aldatu. Berrikusi fitxategia.'
          },
          summaryTitle: 'Sarbide mugatua daten arabera'
        },
        help: {
          inline: 'ZIP fitxategi bat sortu eta esteka publikoarekin duen zerbitzu batean partekatu baduzu, joan ② Esteka sortu atalera.',
          previewTitle: 'Aurreikusi baliabidea deskargatu aurretik (aukerakoa)',
          nextStepText: 'Hurrengo urratsa fitxategia hodeira esteka publikoarekin igotzea da. Ondoren, ② Esteka sortu atalean, itsatsi esteka hori eta sortu partekatzeko esteka.',
    ...
    en: {
      ...
      main: {
        ...
        form: {
          ...
          step: 'Paste the public ZIP link (or .elpx/.h5p) in ② Create link and click “Create link”.',
      ...
      zipper: {
        ...
        status: {
          ...
          downloaded: 'ZIP downloaded. Upload the ZIP to your cloud, share it so everyone can view it, and paste the link in ② Create link.',
          failed: 'Could not create the ZIP. Check the files.',
          created: {
            html: 'ZIP created: web HTML viewer ready. Upload the ZIP to your cloud, share it so everyone can view it, and paste the link in ② Create link.',
            documents: 'ZIP created: document viewer ready. Upload the ZIP to your cloud, share it so everyone can view it, and paste the link in ② Create link.',
            files: 'ZIP created: file viewer ready. Upload the ZIP to your cloud, share it so everyone can view it, and paste the link in ② Create link.'
          }
        },
        step2: {
        ...
        restrict: {
          ...
          status: {
            ...
            done: '{type} ready with restrictions. Upload it to your cloud, share it so everyone can view it, and paste the link in ② Create link.',
            saved: '{type} saved. Upload it to your cloud, share it so everyone can view it, and paste the link in ② Create link.',
        ...
        help: {
          inline: 'If you already created a ZIP, ELPX, or H5P file and shared it on a service with a public link, go to ② Create link.',
          previewTitle: 'Preview the resource before downloading it (optional)',
          nextStepText: 'The next step is to upload your file to the cloud with a public link. Then, in ② Create link, paste that link and create the share link.',
    ...
    de: {
      ...
      main: {
        ...
        form: {
          ...
          step: 'Füge den öffentlichen Link zur ZIP-Datei (oder .elpx/.h5p) in ② Link erstellen ein und klicke auf „Link erstellen“.',
      ...
      zipper: {
        ...
        status: {
          ...
          downloaded: 'ZIP heruntergeladen. Lade die ZIP in deine Cloud hoch, teile sie, damit alle sie sehen können, und füge den Link in ② Link erstellen ein.',
          failed: 'ZIP konnte nicht erstellt werden. Prüfe die Dateien.',
          created: {
            html: 'ZIP erstellt: Web-Viewer bereit. Lade die ZIP in deine Cloud hoch, teile sie, damit alle sie sehen können, und füge den Link in ② Link erstellen ein.',
            documents: 'ZIP erstellt: Dokumenten-Viewer bereit. Lade die ZIP in deine Cloud hoch, teile sie, damit alle sie sehen können, und füge den Link in ② Link erstellen ein.',
            files: 'ZIP erstellt: Datei-Viewer bereit. Lade die ZIP in deine Cloud hoch, teile sie, damit alle sie sehen können, und füge den Link in ② Link erstellen ein.'
          }
        },
        step2: {
        ...
        restrict: {
          ...
          status: {
            ...
            done: '{type} ist mit Einschränkungen bereit. Lade sie in deine Cloud hoch, teile sie, damit alle sie sehen können, und füge den Link in ② Link erstellen ein.',
            saved: '{type} gespeichert. Lade sie in deine Cloud hoch, teile sie, damit alle sie sehen können, und füge den Link in ② Link erstellen ein.',
        ...
        help: {
          inline: 'Wenn du bereits eine ZIP-, ELPX- oder H5P-Datei erstellt und sie über einen Dienst mit öffentlichem Link geteilt hast, gehe zu ② Link erstellen.',
          previewTitle: 'Ressource vor dem Herunterladen vorab ansehen (optional)',
          nextStepText: 'Der nächste Schritt ist, deine Datei mit öffentlichem Link in die Cloud hochzuladen. Danach füge diesen Link in ② Link erstellen ein und erstelle den Freigabelink.',
